...
class StoryNarrator {
	...
	static void narrateAnInterestingStoryWithSuccess(StoryReporter reporter,
            boolean withFailure) {
        ...
        outcomesTable.addOutcome("I don't return all", 100.0, equalTo(100.));
        Date actualDate = dateFor("01/01/2011");
        Date expectedDate = dateFor("01/01/2011");
	...
	static void narrateAnInterestingStoryWithWarnings(StoryReporter reporter,
            boolean withFailure) {
        Properties meta = new Properties();
        meta.setProperty("theme", "testing");
        meta.setProperty("author", "Mauro");
    ...
    static void narrateAnInterestingStoryWithFailures(StoryReporter reporter,
            boolean withFailure) {
        Properties meta = new Properties();
        meta.setProperty("theme", "testing");
        meta.setProperty("author", "Mauro");
